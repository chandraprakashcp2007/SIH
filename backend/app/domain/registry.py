...
DOMAIN_REGISTRY: dict[str, DomainDefinition] = {
    ...
    "VAYU-04": DomainDefinition("VAYU-04", "VAYU", "AIR", ("AIR_POLLUTION", "HAZARDOUS_GAS"), ("pm2_5", "pm10", "co", "voc"), SourceMode.PLANNED, "PLANNED", False, "Air quality and hazardous-gas capability; no live telemetry configured.", _profile("ESP32", ("particulate", "gas", "environmental"), SourceMode.PLANNED)),
    "AKASHA-05": DomainDefinition("AKASHA-05", "AKASHA", "ATMOSPHERE", ("EXTREME_WEATHER", "CYCLONE_CONTEXT"), ("rainfall", "pressure", "wind_speed", "wind_direction"), SourceMode.PLANNED, "PLANNED", False, "Atmospheric intelligence; external meteorological integration pending.", _profile("ESP32", ("pressure", "rainfall", "wind"), SourceMode.PLANNED)),
}
